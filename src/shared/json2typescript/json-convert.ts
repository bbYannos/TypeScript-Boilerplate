...
export class JsonConvert {
    ...
    /**
     * Tries to deserialize a JSON object and update Existing Object Instance.
     *
     * @param jsonObject the JSON object
     * @param instance to update
     *
     * @returns the Updated TypeScript instance
     *
     * @throws an Error in case of failure
     *
     * @author Yannos
     */
    deserializeAndUpdateObject<T>(jsonObject: any, instance: T) {
        if (this.operationMode === OperationMode.DISABLE) {
            return jsonObject;
        }
        ...
        if (this.operationMode === OperationMode.LOGGING) {
            console.log("----------");
            console.log("Receiving JSON object For Update:");
            console.log(jsonObject);
        }
     ...
     * @see https://www.npmjs.com/package/json2typescript full documentation
     */
    deserializeObject<T>(jsonObject: any, classReference: { new(...param): T }): T {
        ...
        const instance: T = new classReference(true);
    ...
    private serializeObject_loopProperty(instance: any, classPropertyName: string, json: any): void {
        ...
        const classInstancePropertyValue: any = instance[classPropertyName];
        ...
        if (typeof (classInstancePropertyValue) === "undefined") {
            ...
            throw new Error(
                "Fatal error in JsonConvert. " +
                "Failed to map the JavaScript instance of class \"" +
                instance[Settings.CLASS_IDENTIFIER] + "\" to JSON because the defined class property \"" +
                classPropertyName + "\" does not exist or is not defined:\n\n" +
                "\tClass property: \n\t\t" + classPropertyName + "\n\n" +
                "\tJSON property: \n\t\t" + jsonPropertyName + "\n\n"
            );
        }
     ...
     */
    public getClassPropertyMappingOptions(instance: any, propertyName: string): MappingOptions | null {
    ...
    private verifyProperty(expectedJsonType: any, value: any, serialize?: boolean): any {
        ...
        if (expectedJsonType instanceof Array === false && value instanceof Array === false) {
            ...
            // Check the type
            if (typeof (expectedJsonType) !== "undefined" && expectedJsonType.prototype.hasOwnProperty(Settings.CLASS_IDENTIFIER)) {
